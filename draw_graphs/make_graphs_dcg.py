...
filename = "result/result_bookmate_dcg.txt"
...
plt.plot(res_p, res_r, linestyle='None', marker='o', color="brown") [0]
res_p, res_r = [list(t) for t in zip(*results["CoClustering"])]
plt.plot(res_p, res_r, linestyle='None', marker='o', color="olive") [0]
res_p, res_r = [list(t) for t in zip(*results["SVD"])]
plt.plot(res_p, res_r, linestyle='None', marker='o', color="blue") [0]
res_p, res_r = [list(t) for t in zip(*results["SlopeOne"])]
plt.plot(res_p, res_r, linestyle='None', marker='o', color="gray") [0]
plt.xlim(0, len(users) + 10)
plt.ylim(0, 1.01)
plt.xlabel("users")
plt.ylabel("ndcg value")
plt.savefig("graphs/surprise_bookmate.png")
